...
parameters = AttributeDict(
    ...
    optimizer=AttributeDict(lr=1e-3, betas="0.9 0.999"),
...
# pdb.set_trace()
# model.load_state_dict(torch.load("test_sdf_sine_0001.pth"))


# model.load_state_dict(torch.load("new2_test_sdf_sine_0001_30_multi_scene.pth"))
model.load_state_dict(\
    torch.load( \
        os.path.join("logs", \
            "tmp_sdf_sine_color_pos_encoding_color5_depth1_sdf6e4_fs1e2_l2_lr1e-4_single_scene", \
            "tmp_sdf_sine_color_pos_encoding_color5_depth1_sdf6e4_fs1e2_l2_lr1e-4_single_scene.pth")))


# model.load_state_dict(torch.load('lightning_logs/sparse_feature_pyramid/chess/version_20/checkpoints/epoch=22-step=17249.ckpt'))
# model = model.load_from_checkpoint('lightning_logs/sparse_feature_pyramid/chess/version_23/checkpoints/epoch=5-step=449.ckpt',\
#                                   hparams_file='lightning_logs/sparse_feature_pyramid/chess/version_23/hparams.yaml')
...
#   pdb.set_trace()
  ...
  mean = test_data_module.camera_info()._color_mean
  std = test_data_module.camera_info()._color_std
